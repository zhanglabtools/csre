...
We correlate the results with RefSeq by this package:
[TxDb.Hsapiens.UCSC.hg19.refGene](https://github.com/wcstcyx/TxDb.Hsapiens.UCSC.hg19.refGene). Install it by
```{r refGene, eval=FALSE, include=TRUE}
...
```{r conflict, eval=FALSE, include=TRUE}
library(tidyverse)
